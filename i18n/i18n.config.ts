export default defineI18nConfig(() => ({
    ...
    messages: {
        es: {
            ...
            addonLabel: 'Paquetes adicionales',
            closingsAddonLabel: 'Incluir cierres Notariado',
            ...
            heroSearch: {
                ...
                tabRent: 'Alquilar',
                tabSell: 'Vender',
                searchPlaceholder: 'Introduce una dirección, población o código postal',
                searchBtn: 'Explorar',
                allSituations: 'Todas las situaciones',
                // Tipologías (alineadas con el contrato del explorer)
                type_residentialAll: 'Todas las viviendas',
                type_multiFamily: 'Solo pisos',
                type_singleFamily: 'Solo chalets',
                type_parking: 'Garaje',
                type_storage: 'Trastero',
                type_rural: 'Rural',
                type_retail: 'Local',
                type_office: 'Oficina',
                type_warehouse: 'Nave',
                type_urban: 'Suelo urbano',
                type_rustic: 'Suelo rústico',
                type_developable: 'Suelo urbanizable',
                type_singularBuilding: 'Edificio singular',
                // Situaciones jurídicas
                legal_NPL: 'NPL',
                legal_REO: 'REO',
                legal_AUCTION_TRANSFER: 'Cesión de remate',
                legal_AUCTION: 'Subasta',
                legal_FULL_OWNERSHIP: 'Pleno dominio',
                legal_BARE_OWNERSHIP: 'Nuda propiedad',
            ...
            propertyListings: {
                ...
                brokerQuestion: '¿Quieres publicar tus propios activos?',
                brokerDesc: 'Accede a la sección Comercial de RESIDELIA y crea anuncios de tus activos para publicarlos en Explorer',
                brokerCta: 'Más información',
            },
            onboardingWizard: {
                buttons: {
                    next: "Siguiente",
        ...
        en: {
            ...
            addonLabel: 'Add-on packages',
            closingsAddonLabel: 'Include Notary closings',
            ...
            heroSearch: {
                ...
                tabRent: 'Rent',
                tabSell: 'Sell',
                searchPlaceholder: 'Enter an address, city or postcode',
                searchBtn: 'Explore',
                allSituations: 'All situations',
                // Property types (aligned with explorer contract)
                type_residentialAll: 'All residential',
                type_multiFamily: 'Apartments only',
                type_singleFamily: 'Houses only',
                ...
                type_urban: 'Urban land',
                type_rustic: 'Rustic land',
                type_developable: 'Developable land',
                type_singularBuilding: 'Singular building',
                // Legal situations
                legal_NPL: 'NPL',
                legal_REO: 'REO',
                legal_AUCTION_TRANSFER: 'Transfer of Award',
                legal_AUCTION: 'Auction',
                legal_FULL_OWNERSHIP: 'Full ownership',
            ...
            propertyListings: {
                ...
                fastTrack: 'Fast track',
                brokerQuestion: 'Want to publish your own assets?',
                brokerDesc: 'Access the RESIDELIA Commercial section and create listings for your assets to publish them in Explorer',
                brokerCta: 'Learn more',
            },
            onboardingWizard: {
                buttons: {
                    next: "Next",
