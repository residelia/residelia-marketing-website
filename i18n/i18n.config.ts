    ...
    messages: {
        es: {
            ...
            heroSearch: {
                ...
                searchBtn: 'Explorar',
                allProperties: 'Todas las viviendas',
                allSituations: 'Todas las situaciones',
                // Tipologías (alineadas con el contrato del explorer)
                type_residentialAll: 'Residencial',
                type_multiFamily: 'Plurifamiliar',
                type_singleFamily: 'Unifamiliar',
                type_rural: 'Rústico',
                type_parking: 'Aparcamiento',
                type_storage: 'Trastero',
                type_retail: 'Local comercial',
                type_office: 'Oficina',
                type_warehouse: 'Nave',
        ...
        en: {
            ...
            heroSearch: {
                ...
                type_residentialAll: 'Residential',
                type_multiFamily: 'Multi-family',
                type_singleFamily: 'Single-family',
                type_rural: 'Rural',
