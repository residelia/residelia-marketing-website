                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="hero-7-txt wow fadeInRight">
                            <!-- Title -->
                            <h2 class="s-54 w-700">Digital marketing that drives results for your business</h2>
                            <!-- Text -->
                            <p class="p-lg">Mauris donec ociis magnis sapien ipsum sagittis sapien tempor and volute gravida aliquet quaerat vitae</p>
                            <!-- HERO QUICK FORM -->
