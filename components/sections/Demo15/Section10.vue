<template>
    <section id="lnk-3" class="pt-100 ct-13 content-section division">
        <div class="container">
            <!-- SECTION TITLE -->
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="txt-block left-column wow fadeInRight">
                        ...
                        <!-- Text -->
                        <p class="mb-0">Tempor sodales sapien quaerat ipsum undo congue laoreet turpis neque auctor turpis vitae dolor luctus placerat magna and ligula cursus purus vitae purus an ipsum suscipit</p>
                    </div>
                </div>
                <!-- END TEXT BLOCK -->
                <!-- TEXT BLOCK -->
