                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="banner-16-txt text-center">
                                <!-- Title -->
                                <h4 class="s-24 w-700">Advanced features available for all</h4>
                                <!-- Text -->
                                ...
                                <div class="txt-block-tra-link mt-15">
                                    <NuxtLink to="/pricing-1" class="tra-link ico-20 color--theme"> View all plan features <span class="flaticon-next"></span> </NuxtLink>
                                </div>
                            </div>
                        </div>
                        <!-- END BANNER-16 TEXT -->
