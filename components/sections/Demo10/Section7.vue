            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6">
                    <div class="txt-block right-column wow fadeInLeft">
                        ...
                        <!-- Title -->
                        <h2 class="s-44 w-700">Work smarter with powerful features</h2>
                        <!-- Text -->
                        ...
                        <div class="txt-block-tra-link mt-25">
                            <a href="#features-12" class="tra-link ico-20 color--theme"> All-in-one platform <span class="flaticon-next"></span> </a>
                        </div>
                    </div>
                </div>
                <!-- END TEXT BLOCK -->
