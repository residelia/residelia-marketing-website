                ...
                <div class="row align-items-center row-cols-1 row-cols-md-2">
                    ...
                    <div class="col">
                        <div id="pt-1-1" class="project-details">
                            <!-- Title -->
                            <h5 class="s-24">Mockup Poster</h5>
                            <!-- Image -->
                            <div class="project-preview r-10">
                                <!-- Project Preview -->
                                <div class="hover-overlay">
                                    <img class="img-fluid" src="/assets/images/projects/project-01.jpg" alt="project-preview" />
                    ...
                    <!-- PROJECT #35 -->
                    <div class="col">
                        <div id="pt-1-5" class="project-details">
                            <!-- Title -->
                            <h5 class="s-24">Vintage Poster</h5>
                            <!-- Image -->
                            <div class="project-preview r-10">
                                <!-- Project Preview -->
                                <div class="hover-overlay">
                    ...
                    <!-- PROJECT #6 -->
                    <div class="col">
                        <div id="pt-1-6" class="project-details">
                            <!-- Title -->
                            <h5 class="s-24">Paper Portrait</h5>
                            <!-- Image -->
                            <div class="project-preview r-10">
                                <!-- Project Preview -->
                                <div class="hover-overlay">
                                    <img class="img-fluid" src="/assets/images/projects/project-06.jpg" alt="project-preview" />
                                    <div class="item-overlay"></div>
                                </div>
                                <!-- Project Link -->
                                <div class="project-link ico-35 color--white">
