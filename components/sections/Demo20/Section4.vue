                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-6 order-last order-md-2">
                            <div class="txt-block left-column wow fadeInRight">
                                <!-- Section ID -->
                                <span class="section-id color--black">Enhance Engagement</span>
                                <!-- Title -->
                                <h2 class="s-44 w-700">Achieve success through data-driven decisions</h2>
                                <!-- List -->
                                ...
                                <div class="txt-block-tra-link mt-25">
                                    <a href="#features-2" class="tra-link ico-20 color--theme"> All-in-one platform <span class="flaticon-next"></span> </a>
                                </div>
                            </div>
                        </div>
                        <!-- END TEXT BLOCK -->
