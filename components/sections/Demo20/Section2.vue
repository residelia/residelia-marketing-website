                    ...
                    <div class="col">
                        <div id="sb-1-2" class="wow fadeInUp">
                            <div class="statistic-block">
                                ...
                                <div class="statistic-block-digit text-center">
                                    <h2 class="s-46 statistic-number">
                                        <span class="count-element d-flex"><ElementsCounterUp :start="0" :end="57" :duration="2000" /> %</span>
                                    </h2>
                                </div>
                                <!-- Text -->
                                <div class="statistic-block-txt color--grey">
                    ...
                    <div class="col">
                        <div id="sb-1-3" class="wow fadeInUp">
                            <div class="statistic-block">
                                ...
                                <div class="statistic-block-digit text-center">
                                    <h2 class="s-46 statistic-number">
                                        <span class="count-element d-flex"><ElementsCounterUp :start="0" :end="67" :duration="2000" /> k</span>
                                    </h2>
                                </div>
                                <!-- Text -->
                                <div class="statistic-block-txt color--grey">
