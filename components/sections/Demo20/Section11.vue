            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6 order-last order-md-2">
                    <div class="txt-block left-column wow fadeInRight">
                        <!-- Section ID -->
                        <span class="section-id color--black">Quick Integration</span>
                        <!-- Title -->
                        <h2 class="s-44 w-700">Easy integrations with your existing tools</h2>
                        <!-- List -->
                        ...
                        <div class="txt-block-tra-link mt-25">
                            <a href="#integrations-1" class="tra-link ico-20 color--theme"> Explore all integrations <span class="flaticon-next"></span> </a>
                        </div>
                    </div>
                </div>
                <!-- END TEXT BLOCK -->
