            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-title mb-70">
                        <!-- Title -->
                        <h2 class="s-52 w-700">Unlock Your Creativity</h2>
                        <!-- Text -->
                ...
                <div class="row row-cols-1 row-cols-md-2 rows-3">
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-2 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Themes & Designs</h6>
                                <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-4 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Drag & Drop Editor</h6>
                                <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-5 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Simple Process</h6>
                                <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-6 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Storage & Backup</h6>
                                <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum</p>
                            </div>
                        </div>
                    </div>
