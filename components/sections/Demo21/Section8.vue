            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-title mb-70">
                        <!-- Title -->
                        <h2 class="s-50 w-700">Free and Open-Source</h2>
                        <!-- Text -->
                ...
                <div class="row row-cols-1 row-cols-md-2 rows-3">
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-1 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Customizable Dashboards</h6>
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-2 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Improved Productivity</h6>
                                <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-3 fbox-11-lst wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Secure Data Transfers</h6>
                                <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-4 fbox-11-lst wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Real Time Statistic</h6>
                                <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum</p>
                            </div>
                        </div>
                    </div>
