                ...
                <div class="row justify-content-md-center row-cols-1 row-cols-md-3">
                    ...
                    <div class="col">
                        <div id="rb-1-1" class="rbox-1">
                            ...
                            <div class="rbox-1-img">
                                <img class="img-fluid" src="/assets/images/brand-21-white.png" alt="feature-image" />
                            </div>
                            <!-- Rating Stars -->
                    ...
                    <div class="col">
                        <div id="rb-1-2" class="rbox-1">
                            <!-- Brand Logo -->
                            <div class="rbox-1-img">
                                <img class="img-fluid" src="/assets/images/brand-22-white.png" alt="feature-image" />
                            </div>
                            <!-- Rating Stars -->
                            <div class="star-rating ico-10 bg--white-100 r-100 clearfix">
                                <span class="flaticon-star"></span>
                    ...
                    <div class="col">
                        <div id="rb-1-3" class="rbox-1">
                            <!-- Brand Logo -->
                            <div class="rbox-1-img">
                                <img class="img-fluid" src="/assets/images/brand-23-white.png" alt="feature-image" />
                            </div>
                            <!-- Rating Stars -->
                            <div class="star-rating ico-10 bg--white-100 r-100 clearfix">
                                <span class="flaticon-star"></span>
