                ...
                <div class="row row-cols-1 row-cols-sm-3 row-cols-md-5">
                    ...
                    <div class="col">
                        <a href="#" class="in_tool it-1 r-12 wow fadeInUp">
                            ...
                            <div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
                                <img class="img-fluid" src="/assets/images/png_icons/tool-9.png" alt="brand-logo" />
                            </div>
                            <!-- Title -->
                            <h6 class="s-17 w-700">Google Drive</h6>
                        </a>
                    </div>
                    <!-- END TOOL #1 -->
                    <!-- TOOL #2 -->
                    <div class="col">
                        <a href="#" class="in_tool it-2 r-12 wow fadeInUp">
                            ...
                            <!-- Title -->
                            <h6 class="s-17 w-700">Dropbox</h6>
                        </a>
                    </div>
                    <!-- END TOOL #2 -->
                    <!-- TOOL #3 -->
                    <div class="col">
                        <a href="#" class="in_tool it-3 r-12 wow fadeInUp">
                            <!-- Logo -->
                            <div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
                                <img class="img-fluid" src="/assets/images/png_icons/tool-13.png" alt="brand-logo" />
                            </div>
                            <!-- Title -->
                            <h6 class="s-17 w-700">Zoom</h6>
                        </a>
                    </div>
                    <!-- END TOOL #3 -->
                    <!-- TOOL #4 -->
                    <div class="col">
                        <a href="#" class="in_tool it-4 r-12 wow fadeInUp">
                            <!-- Logo -->
                            <div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
                                <img class="img-fluid" src="/assets/images/png_icons/tool-12.png" alt="brand-logo" />
                            </div>
                            <!-- Title -->
                            <h6 class="s-17 w-700">Gmail</h6>
                        </a>
                    </div>
                    <!-- END TOOL #4 -->
                    <!-- TOOL #5 -->
                    <div class="col">
                        <a href="#" class="in_tool it-5 r-12 wow fadeInUp">
                            <!-- Logo -->
                            <div class="in_tool_logo ico-65 bg--white-100 block-shadow r-12">
                                <img class="img-fluid" src="/assets/images/png_icons/tool-11.png" alt="brand-logo" />
                            </div>
                            <!-- Title -->
                            <h6 class="s-17 w-700">VLC Player</h6>
                        </a>
                    </div>
                    <!-- END TOOL #5 -->
                </div>
