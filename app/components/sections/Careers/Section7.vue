                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-7">
                            <div class="banner-12-txt color--white">
                                ...
                                <!-- Button -->
                                <NuxtLink :to="$localePath('/contactar?reason=application')" class="btn r-04 btn--theme hover--tra-white" v-follow >Cuéntanos tu experiencia</NuxtLink>
                            </div>
                        </div>
                        <!-- END BANNER-12 TEXT -->
                        <!-- BANNER-12 IMAGE -->
                        <div class="col-md-5">
                            <div class="banner-12-img text-center">
                                <img class="img-fluid" src="/assets/images/img-16.png" alt="banner-image" />
                            </div>
                        </div>
                    </div>
                    <!-- End row -->
