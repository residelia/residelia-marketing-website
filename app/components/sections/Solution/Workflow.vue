<template>
  <section v-if="workflow" id="features-11" class="py-100 features-section division">
    <div class="container">
        ...
        <template v-for="(step, index) in workflow.wfSteps">
          <section
            v-if="(index+1) % 2 !== 0"
            class="pt-70 ct-02 content-section division"
              ...
              <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6">
                  <div class="txt-block right-column">
                    ...
                    <!-- Title -->
                    <h3 class="s-32 w-700">{{step.heading.find(t => t._key === locale).value}}</h3>
                    <!-- Text -->
          ...
          <section v-else id="lnk-3" class="pt-70 ct-01 content-section division" :class="{ 'pb-100': index+1 >= workflow.wfSteps.length }">
            <div class="container">
              <!-- SECTION CONTENT (ROW) -->
              <div class="row d-flex align-items-center">
                <!-- TEXT BLOCK -->
